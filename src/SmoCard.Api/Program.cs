...
using System.Text;
using SmoCard.Api;
using SmoCard.Api.Authorization;
using SmoCard.Api.Filters;
using SmoCard.Api.Services;
using SmoCard.Core.ConfigOptions;
...
var SmoCorsPolicy = "SmoCorsPolicy";
builder.Services.AddSingleton<IAuthorizationPolicyProvider, PermissionPolicyProvider>();
builder.Services.AddScoped<IAuthorizationHandler, PermissionAuthorizationHandler>();

builder.Services.AddCors(o => o.AddPolicy(SmoCorsPolicy, builder =>
{
...
builder.Services.AddDbContext<SmoCardContext>(options =>
                options.UseSqlServer(connectionString));

builder.Services.AddIdentity<AppUser, AppRole>(options => options.SignIn.RequireConfirmedAccount = false)
    .AddEntityFrameworkStores<SmoCardContext>();
